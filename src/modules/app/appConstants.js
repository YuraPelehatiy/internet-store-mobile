...
export const SIGN_IN_START = 'app/SIGN_IN_START';
export const SIGN_IN_OK = 'app/SIGN_IN_OK';
export const SIGN_IN_ERROR = 'app/SIGN_IN_ERROR';

export const SIGN_UP_START = 'app/SIGN_UP_START';
...
export const TOGGLE_LANGUAGE = 'app/TOGGLE_LANGUAGE';